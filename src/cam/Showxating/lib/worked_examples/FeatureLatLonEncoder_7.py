...
# Version 1.7: Integrated FrameObjekt fields
# Version 1.8: Pass FrameObjekt directly into ObjectEncoder
...
class ObjectEncoder:
    ...
    def encode_features(self, frame_objects, hash_histogram=False):
        """
        Encodes FrameObjekt fields into feature vectors.
        """
        ...
        lat_lon_features = [self.encode_lat_lon(obj.avg_loc[0], obj.avg_loc[1]) for obj in frame_objects]
...
encoded_features = encoder.encode_features(frame_objects, hash_histogram=True)
